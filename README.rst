...
For more information on writing a config file, please refer to `Configuration section <https://etn-corp.github.io/memtab/usage.html#configuration>`_ of the usage documentation.
